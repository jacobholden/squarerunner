...
ArrowUpBlueprint::ArrowUpBlueprint(sf::Vector2f position)
{
    position_ = position;
}

void ArrowUpBlueprint::build_blueprint()
{
    ...
    {
        component.drawable = std::make_unique<sf::Sprite>(*TextureManager::get_texture("arrow_up"));
    });
