...
ArrowRightBlueprint::ArrowRightBlueprint(sf::Vector2f position)
{
    position_ = position;
}

void ArrowRightBlueprint::build_blueprint()
{
    ...
    {
        component.drawable = std::make_unique<sf::Sprite>(*TextureManager::get_texture("arrow_right"));
    });
